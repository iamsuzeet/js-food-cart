...
(function() {
  ...
  cartBtn.forEach(cardbtn => {
    cardbtn.addEventListener('click',function(event) {
      ...
      if(event.target.parentElement.classList.contains('store-item-icon')){
        ...
        cartItem.classList.add('card-item','d-flex','justify-content-between','text-capitalize','my-3');
  ...
  function showTotals() {
    ...
    // console.log(total);
    const totalPrice = total.reduce((total, item) => total + item, 0);
